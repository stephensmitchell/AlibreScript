...
AI summary: Creates a 100×100×10 rectangular block, then adds 20 sketches on the top face. Each sketch holds one circle with a unique diameter from 5 mm to 100 mm, offset so the circles don't overlap.
